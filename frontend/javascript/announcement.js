  ...
  const messages = [
    `<div class="d-flex align-items-center">
      <svg xmlns="http://www.w3.org/2000/svg" 
        ...
        fill="currentColor" 
        class="bi bi-exclamation-triangle-fill text-warning-emphasis flex-shrink-0 me-2" 
        viewBox="0 0 16 16"
      >
    ...
    `<div class="d-flex align-items-center">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" 
        width="1rem" height="1rem" 
        fill="currentColor" 
        class="bi bi-emoji-wink-fill text-warning-emphasis flex-shrink-0" 
        viewBox="0 0 16 16"
      >
    ...
    `<div class="d-flex align-items-center">
      <span>
        ...
        <span class="text-warning-emphasis">dos@ya.ru</span>
      </span>
    </div>`
  ];
